...
export class Instrument {
     ...
     * @returns 
     */
    public static mapForPost(instrumentInput: Instrument, roles: string[], user: number[]) {
        const instrumentOutput = {};
        ...
        Object.assign(instrumentOutput, {evaluatorUserId: user[0]});
    ...
    private static getOptions(options: Array<QuestionOption>) {
        ...
        optionsOutput = options.map((opt: QuestionOption) => {
            ...
            if (opt.scoreByCharges && opt.scoreByCharges.length > 0) {
