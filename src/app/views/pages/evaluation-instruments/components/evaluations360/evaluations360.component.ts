...
@Component({
  selector: 'app-evaluations360',
  templateUrl: './evaluations360.component.html',
  styleUrls: ['./evaluations360.component.scss']
})
export class Evaluations360Component extends BaseComponent implements OnInit  {
