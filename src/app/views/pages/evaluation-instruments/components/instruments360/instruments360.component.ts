...
@Component({
  selector: 'app-instruments360',
  templateUrl: './instruments360.component.html',
  styleUrls: ['./instruments360.component.scss']
})
export class Instruments360Component extends BaseComponent implements OnInit  {
  ...
  async ngOnInit() {
    this.instruments = await this.evaluationInstrumentsService.getInstrumentsPagined({ page: environment.paginator.default_page, rowByPage: environment.paginator.row_per_page, word: null });
  ...
  async loadPage(pageInfo: any) {
    ...
    this.instruments = await this.evaluationInstrumentsService.getInstrumentsPagined({ page: this.page, rowByPage: environment.paginator.row_per_page, word: this.word ? this.word : null });
  }
  ...
  async select(id: number) {
    this.selectedItem = await this.evaluationInstrumentsService.getInstrumentsByIdForUpdate(id);
